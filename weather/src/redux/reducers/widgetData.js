...
export default handleActions(
  {
    [UPDATE_SPEED_VALUE]: (state, action) => ({
      ...state,
      dataWeatherWidget: {
        ...state.dataWeatherWidget,
        speed: action.payload,
        showValues: {
          ...state.dataWeatherWidget.showValues,
          isSpeed: !state.dataWeatherWidget.showValues.isSpeed,
        },
      },
    }),
    ...
    [UPDATE_PRESSURE_VALUE]: (state, action) => ({
      ...
      dataWeatherWidget: {
        ...
        showValues: {
          ...state.dataWeatherWidget.showValues,
          isPressure: !state.dataWeatherWidget.showValues.isPressure,
        },
      },
    }),
    [UPDATE_HUMIDITY_VALUE]: (state, action) => ({
      ...
      dataWeatherWidget: {
        ...
        showValues: {
          ...state.dataWeatherWidget.showValues,
          isHumidity: !state.dataWeatherWidget.showValues.isHumidity,
        },
      },
    }),
    ...
    [UPDATE_SUNRISE_VALUE]: (state, action) => ({
      ...
      dataWeatherWidget: {
        ...
        showValues: {
          ...state.dataWeatherWidget.showValues,
          isSunrise: !state.dataWeatherWidget.showValues.isSunrise,
        },
      },
    }),
    ...
    [UPDATE_SUNSET_VALUE]: (state, action) => ({
      ...
      dataWeatherWidget: {
        ...
        showValues: {
          ...state.dataWeatherWidget.showValues,
          isSunset: !state.dataWeatherWidget.showValues.isSunset,
        },
      },
    }),
    ...
    [UPDATE_GEO_VALUE]: (state, action) => ({
      ...
      dataWeatherWidget: {
        ...
        showValues: {
          ...state.dataWeatherWidget.showValues,
          isGeo: !state.dataWeatherWidget.showValues.isGeo,
        },
      },
    }),
  },
